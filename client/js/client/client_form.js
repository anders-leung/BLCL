...
$(document).ready(function(e) {
    ...
    if (client) {
        ...
        if (client.husband) {
            ...
            $('#husbandT4A').prop('checked', client.husband.t4A);
            ...
            $('#husbandRRSPJoint').prop('checked', client.husband.rrsp.spouse);
        ...
        if (client.wife) {
            ...
            $('#wifeT4').prop('checked', client.wife.t4);
            ...
            $('#wifeT4A').prop('checked', client.wife.t4A);
            ...
            $('#wifeRRSPJoint').prop('checked', client.wife.rrsp.spouse);
